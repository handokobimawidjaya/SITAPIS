...
Follows SK KPU No. 1257/2024 numbering format:
  {NO}/{KLASIFIKASI}-{JENIS}/{SATKER}/{TAHUN}
...
@transaction.atomic
def generate_nomor_surat(jenis_naskah, klasifikasi, user):
    """
    ...
    The counter is per unique combination of (jenis_naskah, satker, tahun).
    ...
    Returns:
        str: Formatted letter number, e.g. ``1/PY.01.1-SD/1101/2024``.
    """
